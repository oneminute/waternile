        ...
        try {
          ...
          _.each(modelIdentities, function(modelIdentity) {
            ...
            assert(
              ...
              'Expecting truthy string in `WLModel.classType`, but got something else. (Please open an issue: http://github.com/gaithoben/sails-orient-js/issues)'
            );
            assert(
              WLModel.indexes && _.isArray(WLModel.indexes),
              'Expecting truthy Array in `WLModel.indexes`, but got something else. (Please open an issue: http://github.com/gaithoben/sails-orient-js/issues)'
            );
