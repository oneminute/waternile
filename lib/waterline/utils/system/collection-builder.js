...
module.exports = function CollectionBuilder(collection, datastores, context) {
  ...
  // Find the defaultDatastoreBuild used by this collection. If none are specified check
  if (collection.prototype.defaultDatastoreBuild === undefined) {
    // Set the defaultDatastoreBuild to document
    collection.prototype.defaultDatastoreBuild = 'only';
  }
