...
var DEFERRED_METHODS = getQueryModifierMethods('normalize');
...
module.exports = function normalize(newRecord, explicitCbMaybe, metaContainer) {
    ...
    function(done) {
      ...
      adapter.normalize(
        ...
        function _afterTalkingToAdapter(err, rawAdapterResult) {
          if (err) {
            err = forgeAdapterError(err, omen, 'normalize', modelIdentity, orm);
            return done(err);
          } //-•
